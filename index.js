...
// we need to load the http library before we call this in the code
...
// anything following a colon, it creates a variable.
app.get('/search/:thing', function(req, res){

// we are accessing the variable here, it's looking for variables in the query
	var searchQuery = req.params.thing

// this module searches giphy, and asks it to send back a url looking for the index 0 url
...
// we are listening in side this for an open connection
io.on('connection', function(socket){
	console.log("new client connected")

	socket.on("chat", function(data){
		//io will send to everyone that's connected
		// socket will only send to client
		// we use io here because we have previously passed socket in the function
